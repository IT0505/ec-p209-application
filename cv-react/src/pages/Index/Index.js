...
function Index() {
  const handleSectionVisible = () => {
    ...
    if (home) {
      if (
        document.documentElement.scrollTop >
          home.getBoundingClientRect().top - 800 &&
    ...
    if (about) {
      if (
        document.documentElement.scrollTop >
          about.getBoundingClientRect().top - 800 &&
    ...
    if (education) {
      if (
        document.documentElement.scrollTop >
          education.getBoundingClientRect().top - 800 &&
        education.style.visibility === ""
      ) {
