  ...
  return (
    <div className='blog-content'>
      {blogData.map((data, index) => (
        <div
          className={index % 2 === 0 ? 'content-wrap' : 'content-wrap odd'}
          key={index}
        >
          <figure className='content-image img'>
            ...
            <figcaption className='content-caption'>
              <p className='caption-txt'>
                ...
                {data.img.caption.author}
                <i className='far fa-clock icon'></i>
                {data.img.caption.time}
                <i className='fas fa-comments icon'></i>
                {data.img.caption.cmt}
              </p>
            </figcaption>
          </figure>
          <div className='content-text'>
            ...
            <a className='forward' href={data.forward}>
              Read More
            </a>
          </div>
        </div>
